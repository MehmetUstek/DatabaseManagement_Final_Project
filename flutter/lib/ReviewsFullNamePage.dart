...
class ReviewsFullNamePage extends StatefulWidget {
  const ReviewsFullNamePage(
      {Key? key,
        required this.reviewList,})
      : super(key: key);
  final List<ReviewFullName> reviewList;
  @override
  _ReviewsFullNamePageState createState() => _ReviewsFullNamePageState();
}

class _ReviewsFullNamePageState extends State<ReviewsFullNamePage> {
                ...
                Expanded(
                  child: ListView.separated(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      ReviewFullName review = reviewList[index];
                      return
                        Container(
                          height: 120,
